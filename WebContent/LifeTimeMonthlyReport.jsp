...
                                  
	                $('#LifeTimeMembershipReportButton').click(function(event) { 
		...
		var WhichFunctionToHandle="LifeMemberMonthlyReport";
	
		
		                 $.get('AjaxServlet',{StatusOfTheAdvocate:StatusOfTheAdvocate,EndDate:EndDate,WhichFunctionToHandle:WhichFunctionToHandle,StartDate:StartDate},function(responseText) { 
