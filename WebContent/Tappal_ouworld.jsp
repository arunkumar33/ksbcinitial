...
<div class="container" style="width: 100%">
    ...
    <form class="well form-horizontal" action="Tapaloutworld" method="post"  >
    <!-- id="contact_form" -->
<fieldset>

<!-- Form Name -->
<legend>Tappal Out World <br> All the fields are mandatory</legend>
...
<div class="form-group">
  ...
  <div class="form-group">
  <label class="col-md-4 control-label">postalCharge</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="postalCharge" placeholder="postalCharge" class="form-control" type="Number" value="0">
    </div>
  </div>
</div>
