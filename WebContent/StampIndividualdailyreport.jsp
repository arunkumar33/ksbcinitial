...
<input type="hidden" value="DailyReportForInidividualAssociation" name="SearchWithKARNumberForStatusChange" id="WhichFunctionToHandle">
		<input type="button" name="SearchWithRegNumber" class="btn btn-info" value="Submit"  id="SearchWithKARNumberForStatusChange"  >
