...
<form action="StampSectionAssociation" method="post">
	<table>

			
<tr>
    <td>Name</td>
    <td><input type="text" name="district" id="Name"></td>
  </tr>
  
   <tr>
    <td>Place</td>
    <td><input type="text" name="associationName" id="Place"></td>
  </tr>
		<tr></tr>
		<tr></tr>
...
<td>
<input type="text" name="RecepitNumber" id="RecepitNumber" value="0" onblur="GetEnrollmentDetailsForCashSection1()"></td>
</tr>
<tr>
<td>Gross Amount</td>
<td>
<input type="text" name="Gross_Amount"  id="Gross_Amount"  value="0"></td>
</tr>
<tr>
<td>Total Amount</td>
<td>
...
document.getElementById("Gross_Amount").value=	StringArry[1];
	...
	/* 	document.getElementById("KARNumber").value=	StringArry[4]; */
		document.getElementById("Name").value=	StringArry[6];
		document.getElementById("Place").value=	StringArry[4];
