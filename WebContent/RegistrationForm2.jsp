...
<div class="container" style="width: 100%">
    ...
    <form class="well form-horizontal" action="RegistrationForm3" method="post" >
<fieldset>
...
<div class="form-group">
 ...
 (In Block Letters as per Provisional Certificate)</label>  
  <div class="col-md-4 inputGroupContainer">
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="FullName" placeholder="University Name" class="form-control"  type="text">
    </div>
  </div>
</div>
...
<div class="form-group"> 
  <label class="col-md-4 control-label">Place or Places of Practice</label>
...
<div class="form-group">
  <label class="col-md-4 control-label"> Suspension or discontinuance of Practice if any,  with details of suspension and resumption
</label>
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
        	<textarea class="form-control" name="discontinuanceOfPractice" placeholder=" Please Give Details"></textarea>
  </div>
  </div>
</div>
<!-- Previous employment or profession with details of nature and period,  if any  -->
<div class="form-group">
  <label class="col-md-4 control-label">Previous employment or profession with details of nature and period,  if any
</label>
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
        	<textarea class="form-control" name="PreviousEmployment" placeholder="Please Give Details"></textarea>
  </div>
  </div>
</div>
...
<!-- Name, age and address of Nominee or Nominees & relationship (In case nominee is Minor, mention the Date of Birth and Name of the Guardian)-->
