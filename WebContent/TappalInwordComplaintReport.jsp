...
<input type="text" placeholder="In Word Complaint ID" value="" id="INworldID"/>
<input type="hidden" value="GetReportForTappalInworldComplaint" name="SearchWithKARNumberForDuplicateCertificate" id="WhichFunctionToHandle">
