...
<input type="hidden" value="SelectForChallanUpload" name="SelectForChallanUpload" id="WhichFunctionToHandle">
		<input type="button" class="btn btn-info" name="ChallanUploadButton" value="Submit"  id="ChallanUploadButton"  >
...
<script>
                                
	                $('#ChallanUploadButton').click(function(event) { 
	alert("*********************");
