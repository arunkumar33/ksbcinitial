...
<input type="hidden" value="ViewKARStatus" name="WhichFunctionToHandle" id="WhichFunctionToHandle">
		<input type="button" name="SearchWithKARNumber" value="Submit" class="btn btn-info"  id="SearchWithKARNumber"  >
