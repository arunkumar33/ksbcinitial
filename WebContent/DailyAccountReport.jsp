...
<input type="hidden" value="DailyReportForCashSection" name="SearchWithKARNumberForStatusChange" id="WhichFunctionToHandle">
		<input type="button" name="SearchWithRegNumber" value="Submit" class="btn btn-info" id="SearchWithKARNumberForStatusChange"  class="btn btn-info">
