            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-file-pdf-o"></i>Tappal Section<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <!-- <li><a href="index.html">Schedule Interview</a></li> -->
						  <li><a onclick="LoadJspIntoTheDIV('TappalInword.jsp')"><b>Tappal In World</b></a></li>
						<li><a onclick="LoadJspIntoTheDIV('Tappal_ouworld.jsp')"><b>Tappal Out World</b></a></li>
                    <li><a onclick="LoadJspIntoTheDIV('TappalInwordComplaint.jsp')"><b>Tappal Complaint In World</b></a></li>
                    
                       <li><a onclick="LoadJspIntoTheDIV('TappalAssert.jsp')">Tappal Assert</a></li>
                   ...
                   <li><a><i class="fa fa-credit-card"></i>Report Generation<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a onclick="LoadJspIntoTheDIV('TappalInwordReport.jsp')"><b>Tappal In World Report</b></a></li>
                      <li><a onclick="LoadJspIntoTheDIV('TappalOutWorldReport.jsp')"><b>Tappal Out World Report</b></a></li>
                      
                       <li><a onclick="LoadJspIntoTheDIV('TappalInwordComplaintReport.jsp')"><b>Tappal Comaplaint In World Report</b></a></li>
                     
                      <li><a onclick="LoadJspIntoTheDIV('TappalAssertReport.jsp')"><b>Tappal Assert Report</b></a></li>
                       <li><a onclick="LoadJspIntoTheDIV('TodoListOfTappal.jsp')"><b>Todo List Of Tappal</b></a></li>
