...
<br/> <br/>
<form>
<label>Select Place of Practice of the Advocate</label>
<select name="StatusOfTheAdvocate" class="form-control selectpicker"  id="StatusOfTheAdvocate">
       <option>All</option>
...
<option value="Bengaluru Urban">Bengaluru Urban</option>
      ...
      <option value="Gadag">Haveri</option>
...
                                  
	...
	alert ("LifeTimeMembershipReportButton part");
		...
		alert(EndDate);
		var StatusOfTheAdvocate=$('#StatusOfTheAdvocate').val();
		alert(StatusOfTheAdvocate);
		...
		                  $.get('AjaxServlet',{GenderCategory:GenderCategory,CastCategory:CastCategory,StatusOfTheAdvocate:StatusOfTheAdvocate,EndDate:EndDate,WhichFunctionToHandle:WhichFunctionToHandle,StartDate:StartDate},function(responseText) { 
