            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-file-pdf-o"></i>DC Complient<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <!-- <li><a href="index.html">Schedule Interview</a></li> -->
						
						<li><a onclick="LoadJspIntoTheDIV('DCComplient.jsp')"><b>Complient</b></a></li>
                      <li><a onclick="LoadJspIntoTheDIV('UpdateDCComplient.jsp')"><b>Update Complient</b></a></li>
                  ...
                  <li><a><i class="fa fa-credit-card"></i>Generate Report<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a onclick="LoadJspIntoTheDIV('DCComplientGenerateReport.jsp')"><b>Generate Report</b></a></li>
                    
                 <li><a onclick="LoadJspIntoTheDIV('DCComplientTodoList.jsp')"><b>Todo List</b></a></li>
                    </ul>
                  </li>
