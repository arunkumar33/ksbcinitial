...
<input type="text" placeholder="KAR Number For Billing Information"  id="KARNumber" name="KARNumber"/>
</br>
<input type="hidden" value="GetKARBillingStatus" name="WhichFunctionToHandle" id="WhichFunctionToHandle">
