...
<input type="text" placeholder="Nominee Name" value="" id="NomineeName"/>
</br> </br>
...
                                
	...
	alert("*********************");
		...
		var NomineeName= $('#NomineeName').val(); //RelationShip
		var RelationShip= $('#RelationShip').val(); 
		var WhichFunctionToHandle=$('#WhichFunctionToHandle').val();
		                 $.get('AjaxServlet',{RelationShip:RelationShip,NomineeName:NomineeName,KARNumber:KARNumber,WhichFunctionToHandle:WhichFunctionToHandle},function(responseText) { 
