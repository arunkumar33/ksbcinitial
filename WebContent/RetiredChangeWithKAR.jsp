<h3>Hi.. You can Generate Retired advocate Report Here</h3>
<br/>
...
<input type="hidden" value="RetiredAdvocateReport" name="RetiredAdvocateReport" id="WhichFunctionToHandle">
<br/> <br/>
...
                                  
	...
	alert ("RetiredAdvocateReport part");
