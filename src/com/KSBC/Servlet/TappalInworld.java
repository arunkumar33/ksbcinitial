...
/**
 * Servlet implementation class TappalInworld
 */
/*@WebServlet("/TappalInworld")*/
public class TappalInworld extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TappalInworld() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Tappal_Inworld Tappal_Outworld= new Tappal_Inworld();
...
int year=2017;
String World="KSBC/TAPPAL/IN/"+id+"/"+year;
