...
/**
 * Servlet implementation class OfflineFileImageUpdate
 */
@WebServlet("/OfflineFileImageUpdate")
public class OfflineFileImageUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OfflineFileImageUpdate() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String WhichChallan = request.getParameter("WhichChallan");
              ...
              int index=0;
                ...
                else
                {
                	...
                	if(BlobList.size()==1)
                	{
                		...
                		Hibernatesession.update(FileUploadBean);
                		transaction.commit();	 
                	}
