...
@Entity
@Table(name="ValidatedFinalBean")
public class ValidatedFinalBean {
	...
	@Id
	@Column(name="KARNumber",nullable=false,unique=true)
	...
	private String KARStatus="Active";
	public String getKARStatus() {
		return KARStatus;
	}

	public void setKARStatus(String kARStatus) {
		KARStatus = kARStatus;
	}
